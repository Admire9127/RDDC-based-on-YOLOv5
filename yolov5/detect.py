...
def run(
        ...
        source=ROOT / '病害(1).mp4',  # file/dir/URL/glob/screen/0(webcam)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / '病害(1).mp4', help='file/dir/URL/glob/screen/0(webcam)')
